...
import Statusindialog from "../../components/StatusInDialog/Statusindialog";
import ChatInput from "../../components/ChatInput/ChatInput";
import DialogsContainer from "../../Containers/DialogContainer";
                    ...
                    <div className="chat__dialog-header">
                        <div className="chat__dialog-header-center">
                            ...
                            <div className="chat__dialog-header-status">
                                <Statusindialog online={false}/>
                            </div>
                        </div>
                        <EllipsisOutlined className={'edit'}/>
                    </div>
